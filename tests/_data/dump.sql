...
# Database: sites_textman
# Generation Time: 2018-01-05 14:46:45 +0000
# ************************************************************
...
# Dump of table j_activities_resources
# ------------------------------------------------------------

DROP TABLE IF EXISTS `j_activities_resources`;

CREATE TABLE `j_activities_resources` (
...
LOCK TABLES `j_activities_resources` WRITE;
/*!40000 ALTER TABLE `j_activities_resources` DISABLE KEYS */;

INSERT INTO `j_activities_resources` (`activities_resource_id`, `uuid`, `package`, `name`, `resource_id`, `title`, `created_on`, `data`)
VALUES
	(1,'9a447789-bb5c-4566-b9f1-8f634c9a5fd3','installer','plugin','10030','plg_content_filelink','2018-01-05 14:43:00','[]'),
	(2,'feef7726-ac77-4325-b314-24df364ed90b','installer','plugin','10031','plg_editors-xtd_filelink','2018-01-05 14:43:01','[]'),
	(3,'4c1f6263-9ed4-4197-8d70-830e4ee00ae6','installer','plugin','10032','plg_editors-xtd_attachments','2018-01-05 14:43:01','[]'),
	(4,'d3248748-9a92-4b14-a8e0-eff882f01055','installer','plugin','10033','plg_koowa_fileman','2018-01-05 14:43:01','[]'),
	(5,'c5c55c20-9360-439e-81c0-05f2216efb22','installer','plugin','10027','plg_system_joomlatoolsupdater','2018-01-05 14:43:01','[]'),
	(6,'33e152dc-1354-4a81-902b-7fc2ce341082','installer','plugin','10034','plg_system_joomlatoolsscheduler','2018-01-05 14:43:01','[]'),
	(7,'ce576a63-0913-4f71-b563-164d2f2ffcf8','installer','module','10035','mod_fileman_folders','2018-01-05 14:43:01','[]'),
	(8,'f539b665-1ce3-4e87-aad6-8e561f90329c','installer','module','10036','mod_fileman_files','2018-01-05 14:43:02','[]'),
	(9,'4f29221f-d1dd-4fb8-a39a-e2c2c76bd0ef','installer','component','10029','com_fileman','2018-01-05 14:43:02','[]'),
	(10,'796ecc0f-3afe-4193-b41a-26eb2be9bd82','installer','plugin','10039','plg_content_textman','2018-01-05 14:45:07','[]'),
	(11,'515da575-0fc3-4b1f-b9c3-1d9cccada684','installer','plugin','10040','plg_system_textman','2018-01-05 14:45:08','[]'),
	(12,'f54c782b-d748-4f3f-8bdb-af8edf181f15','installer','plugin','10041','plg_logman_textman','2018-01-05 14:45:08','[]'),
	(13,'1843f89c-1958-4c5f-8e9f-3dc5cfdba529','installer','plugin','10042','plg_textman_notify','2018-01-05 14:45:08','[]'),
	(14,'19a6417f-2d2d-444f-ac65-7952e6c56e8a','installer','component','10038','com_textman','2018-01-05 14:45:46','[]'),
	(15,'a7c26b02-d5f0-4026-826b-85826217242d','installer','plugin','10044','plg_koowa_connect','2018-01-05 14:46:00','[]');

/*!40000 ALTER TABLE `j_activities_resources` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(18,1,316,325,1,'com_modules','com_modules','{\"core.admin\":{\"7\":1}}'),
	(19,1,326,333,1,'com_newsfeeds','com_newsfeeds','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1}}'),
	(20,1,334,335,1,'com_plugins','com_plugins','{\"core.admin\":{\"7\":1}}'),
	(21,1,336,337,1,'com_redirect','com_redirect','{\"core.admin\":{\"7\":1}}'),
	(22,1,338,339,1,'com_search','com_search','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1}}'),
	(23,1,340,341,1,'com_templates','com_templates','{\"core.admin\":{\"7\":1}}'),
	(24,1,342,345,1,'com_users','com_users','{\"core.admin\":{\"7\":1}}'),
	(26,1,346,347,1,'com_wrapper','com_wrapper','{}'),
	(33,1,426,427,1,'com_finder','com_finder','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1}}'),
	...
	(37,19,329,330,2,'com_newsfeeds.category.12','Uncategorised','{}'),
	...
	(42,19,331,332,2,'com_newsfeeds.category.17','Sample Data-Newsfeeds','{}'),
	...
	(169,24,343,344,2,'com_users.category.77','Uncategorised','{}'),
	...
	(173,1,428,429,1,'com_joomlaupdate','com_joomlaupdate','{}'),
	...
	(175,1,430,431,1,'com_tags','com_tags','{\"core.admin\":{\"8\":1},\"core.manage\":{\"7\":1},\"core.create\":{\"6\":1,\"3\":1},\"core.delete\":{\"6\":1},\"core.edit\":{\"6\":1,\"4\":1},\"core.edit.state\":{\"6\":1,\"5\":1}}'),
	(176,1,432,433,1,'com_contenthistory','com_contenthistory','{}'),
	(177,1,434,435,1,'com_ajax','com_ajax','{}'),
	(178,1,436,437,1,'com_postinstall','com_postinstall','{}'),
	(180,1,438,439,1,'com_logman','com_logman','{}'),
	(181,18,317,318,2,'com_modules.module.91','LOGman - Activity Stream','{}'),
	(182,18,319,320,2,'com_modules.module.92','LOGman - Activity Stream','{}'),
	(184,1,440,441,1,'com_fileman','com_fileman','{\"core.admin\":[],\"core.manage\":{\"6\":1},\"core.create\":[],\"core.delete\":[],\"core.edit\":[]}'),
	(185,18,321,322,2,'com_modules.module.93','FILEman - Folders','{}'),
	(186,18,323,324,2,'com_modules.module.94','FILEman - Files','{}'),
	(188,1,442,443,1,'com_textman','com_textman','{}');
...
VALUES
	...
	(103,0,'Joomla! Platform','library','joomla','',0,1,1,1,'{\"version\": \"3.8.3\"}','{\"mediaversion\":\"de0c6e30833963b619eca2ca7cae2f84\"}','','',0,'0000-00-00 00:00:00',0,0),
	...
	(452,0,'plg_system_updatenotification','plugin','updatenotification','system',0,1,1,0,'{\"version\": \"3.8.3\"}','{\"lastrun\":1515163310}','','',0,'0000-00-00 00:00:00',0,0),
	(453,0,'plg_editors-xtd_module','plugin','module','editors-xtd',0,1,1,0,'{\"version\": \"3.8.3\"}','','','',0,'0000-00-00 00:00:00',0,0),
	(454,0,'plg_system_stats','plugin','stats','system',0,1,1,0,'{\"version\": \"3.8.3\"}','{\"mode\":3,\"lastrun\":1515163353,\"unique_id\":\"92d2f991981e902f048c8971d57462d2a7743877\",\"interval\":12}','','',0,'0000-00-00 00:00:00',0,0),
	...
	(10003,0,'com_logman','component','com_logman','',1,1,0,0,'{\"name\":\"com_logman\",\"type\":\"component\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"User Activity Stream\",\"group\":\"\",\"filename\":\"logman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10004,0,'MOD_LOGMAN','module','mod_logman','',1,1,2,0,'{\"name\":\"MOD_LOGMAN\",\"type\":\"module\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"MOD_LOGMAN_DESCRIPTION\",\"group\":\"\",\"filename\":\"mod_logman\"}','{\"limit\":\"10\",\"direction\":\"desc\",\"user_filter\":\"0\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10005,0,'MOD_LOGMAN','module','mod_logman','',0,1,0,0,'{\"name\":\"MOD_LOGMAN\",\"type\":\"module\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"MOD_LOGMAN_DESCRIPTION\",\"group\":\"\",\"filename\":\"mod_logman\"}','{\"limit\":\"10\",\"user_filter\":\"0\",\"show_date\":\"0\",\"show_time\":\"0\",\"show_icons\":\"1\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10006,0,'plg_koowa_logman','plugin','logman','koowa',0,1,1,0,'{\"name\":\"plg_koowa_logman\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_KOOWA_LOGMAN_DESC\",\"group\":\"\",\"filename\":\"logman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10007,0,'plg_editors-xtd_logmanlinker','plugin','logmanlinker','editors-xtd',0,1,1,0,'{\"name\":\"plg_editors-xtd_logmanlinker\",\"type\":\"plugin\",\"creationDate\":\"August 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.1\",\"description\":\"PLG_LOGMANLINKER_DESCRIPTION\",\"group\":\"\",\"filename\":\"logmanlinker\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10008,0,'plg_logman_banners','plugin','banners','logman',0,1,1,0,'{\"name\":\"plg_logman_banners\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 - 2017 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_BANNERS_DESC\",\"group\":\"\",\"filename\":\"banners\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10009,0,'plg_logman_categories','plugin','categories','logman',0,1,1,0,'{\"name\":\"plg_logman_categories\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_CATEGORIES_DESC\",\"group\":\"\",\"filename\":\"categories\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10010,0,'plg_logman_config','plugin','config','logman',0,1,1,0,'{\"name\":\"plg_logman_config\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_CONFIG_DESC\",\"group\":\"\",\"filename\":\"config\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10011,0,'plg_logman_contact','plugin','contact','logman',0,1,1,0,'{\"name\":\"plg_logman_contact\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_CONTACT_DESC\",\"group\":\"\",\"filename\":\"contact\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10012,0,'plg_logman_content','plugin','content','logman',0,1,1,0,'{\"name\":\"plg_logman_content\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_CONTENT_DESC\",\"group\":\"\",\"filename\":\"content\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10013,0,'plg_logman_docman','plugin','docman','logman',0,1,1,0,'{\"name\":\"plg_logman_docman\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_DOCMAN_DESC\",\"group\":\"\",\"filename\":\"docman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10014,0,'plg_logman_fileman','plugin','fileman','logman',0,1,1,0,'{\"name\":\"plg_logman_fileman\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_FILEMAN_DESC\",\"group\":\"\",\"filename\":\"fileman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10015,0,'plg_logman_installer','plugin','installer','logman',0,1,1,0,'{\"name\":\"plg_logman_installer\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_INSTALLER_DESC\",\"group\":\"\",\"filename\":\"installer\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10016,0,'plg_logman_joomlaupdate','plugin','joomlaupdate','logman',0,1,1,0,'{\"name\":\"plg_logman_joomlaupdate\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_JOOMLAUPDATE_DESC\",\"group\":\"\",\"filename\":\"joomlaupdate\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10017,0,'plg_logman_languages','plugin','languages','logman',0,1,1,0,'{\"name\":\"plg_logman_languages\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_LANGUAGES_DESC\",\"group\":\"\",\"filename\":\"languages\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10018,0,'plg_logman_menus','plugin','menus','logman',0,1,1,0,'{\"name\":\"plg_logman_menus\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_MENUS_DESC\",\"group\":\"\",\"filename\":\"menus\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10019,0,'plg_logman_modules','plugin','modules','logman',0,1,1,0,'{\"name\":\"plg_logman_modules\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_MODULES_DESC\",\"group\":\"\",\"filename\":\"modules\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10020,0,'plg_logman_newsfeeds','plugin','newsfeeds','logman',0,1,1,0,'{\"name\":\"plg_logman_newsfeeds\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_NEWSFEEDS_DESC\",\"group\":\"\",\"filename\":\"newsfeeds\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10021,0,'plg_logman_notifier','plugin','notifier','logman',0,1,1,0,'{\"name\":\"plg_logman_notifier\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_NOTIFIER_DESC\",\"group\":\"\",\"filename\":\"notifier\"}','{\"notify_userlog_actions\":\"1\",\"html\":\"1\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10022,0,'plg_logman_plugins','plugin','plugins','logman',0,1,1,0,'{\"name\":\"plg_logman_plugins\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_PLUGINS_DESC\",\"group\":\"\",\"filename\":\"plugins\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10023,0,'plg_logman_redirect','plugin','redirect','logman',0,1,1,0,'{\"name\":\"plg_logman_redirect\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_REDIRECT_DESC\",\"group\":\"\",\"filename\":\"redirect\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10024,0,'plg_logman_templates','plugin','templates','logman',0,1,1,0,'{\"name\":\"plg_logman_templates\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_TEMPLATES_DESC\",\"group\":\"\",\"filename\":\"templates\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10025,0,'plg_logman_users','plugin','users','logman',0,1,1,0,'{\"name\":\"plg_logman_users\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_USERS_DESC\",\"group\":\"\",\"filename\":\"users\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10026,0,'plg_logman_weblinks','plugin','weblinks','logman',0,1,1,0,'{\"name\":\"plg_logman_weblinks\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_LOGMAN_WEBLINKS_DESC\",\"group\":\"\",\"filename\":\"weblinks\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10027,0,'plg_system_joomlatoolsupdater','plugin','joomlatoolsupdater','system',0,1,1,0,'{\"name\":\"plg_system_joomlatoolsupdater\",\"type\":\"plugin\",\"creationDate\":\"June 2016\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2016 Timble CVBA\",\"authorEmail\":\"info@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"1.0.0\",\"description\":\"\",\"group\":\"\",\"filename\":\"joomlatoolsupdater\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10029,0,'com_fileman','component','com_fileman','',1,1,0,0,'{\"name\":\"com_fileman\",\"type\":\"component\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"Advanced Media Manager\",\"group\":\"\",\"filename\":\"fileman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10030,0,'plg_content_filelink','plugin','filelink','content',0,1,1,0,'{\"name\":\"plg_content_filelink\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_CONTENT_FILELINK_DESCRIPTION\",\"group\":\"\",\"filename\":\"filelink\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10031,0,'Button - FILElink','plugin','filelink','editors-xtd',0,1,1,0,'{\"name\":\"Button - FILElink\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"\",\"group\":\"\",\"filename\":\"filelink\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10032,0,'Button - Attachments','plugin','attachments','editors-xtd',0,1,1,0,'{\"name\":\"Button - Attachments\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"\",\"group\":\"\",\"filename\":\"attachments\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10033,0,'plg_koowa_fileman','plugin','fileman','koowa',0,1,1,0,'{\"name\":\"plg_koowa_fileman\",\"type\":\"plugin\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"PLG_KOOWA_FILEMAN_DESC\",\"group\":\"\",\"filename\":\"fileman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10034,0,'plg_system_joomlatoolsscheduler','plugin','joomlatoolsscheduler','system',0,1,1,0,'{\"name\":\"plg_system_joomlatoolsscheduler\",\"type\":\"plugin\",\"creationDate\":\"September 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2015 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"1.0.0\",\"description\":\"\",\"group\":\"\",\"filename\":\"joomlatoolsscheduler\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10035,0,'mod_fileman_folders','module','mod_fileman_folders','',0,1,0,0,'{\"name\":\"mod_fileman_folders\",\"type\":\"module\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"MOD_FILEMAN_FOLDERS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"mod_fileman_folders\"}','{\"page\":\"\",\"folder\":\"\",\"tree\":\"1\",\"limit\":\"10\",\"show_icon\":\"1\",\"humanize_filenames\":\"1\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10036,0,'mod_fileman_files','module','mod_fileman_files','',0,1,0,0,'{\"name\":\"mod_fileman_files\",\"type\":\"module\",\"creationDate\":\"November 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"3.1.2\",\"description\":\"MOD_FILEMAN_FILES_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"mod_fileman_files\"}','{\"page\":\"\",\"folder\":\"\",\"limit\":\"10\",\"layout\":\"_:default.html\",\"track_downloads\":\"1\",\"show_icon\":\"1\",\"show_filenames\":\"1\",\"humanize_filenames\":\"1\",\"sort\":\"name\",\"direction\":\"asc\",\"download_in_blank_page\":\"0\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10038,0,'com_textman','component','com_textman','',1,1,0,0,'{\"name\":\"com_textman\",\"type\":\"component\",\"creationDate\":\"December 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2017 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"2.0.0\",\"description\":\"COM_TEXTMAN_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"textman\"}','{\"readmore_limit\":200,\"toolbar_location\":\"k-edit-bar--top\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10039,0,'plg_content_textman','plugin','textman','content',0,1,1,0,'{\"name\":\"plg_content_textman\",\"type\":\"plugin\",\"creationDate\":\"December 2016\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2016 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"2.0.0\",\"description\":\"PLG_CONTENT_TEXTMAN_DESCRIPTION\",\"group\":\"\",\"filename\":\"textman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10040,0,'plg_system_textman','plugin','textman','system',0,1,1,0,'{\"name\":\"plg_system_textman\",\"type\":\"plugin\",\"creationDate\":\"March 2016\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2016 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"2.0.0\",\"description\":\"PLG_SYSTEM_TEXTMAN_DESCRIPTION\",\"group\":\"\",\"filename\":\"textman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10041,0,'plg_logman_textman','plugin','textman','logman',0,1,1,0,'{\"name\":\"plg_logman_textman\",\"type\":\"plugin\",\"creationDate\":\"April 2017\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 - 2017 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"2.0.0\",\"description\":\"PLG_LOGMAN_TEXTMAN_DESC\",\"group\":\"\",\"filename\":\"textman\"}','{}','','',0,'0000-00-00 00:00:00',0,0),
	(10042,0,'plg_textman_notify','plugin','notify','textman',0,1,1,0,'{\"name\":\"plg_textman_notify\",\"type\":\"plugin\",\"creationDate\":\"October 2016\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2011 Timble CVBA (http:\\/\\/www.timble.net)\",\"authorEmail\":\"support@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"2.0.0\",\"description\":\"PLG_TEXTMAN_NOTIFY_DESCRIPTION\",\"group\":\"\",\"filename\":\"notify\"}','{\"notify_article\":\"1\",\"notify_article_group\":\"0\",\"notify_category\":\"0\",\"notify_add\":\"1\",\"notify_edit\":\"1\",\"notify_delete\":\"1\",\"notify_publish\":\"1\",\"notify_trash\":\"1\",\"notify_restore\":\"1\"}','','',0,'0000-00-00 00:00:00',0,0),
	(10044,0,'plg_koowa_connect','plugin','connect','koowa',0,1,1,0,'{\"name\":\"plg_koowa_connect\",\"type\":\"plugin\",\"creationDate\":\"September 2016\",\"author\":\"Joomlatools\",\"copyright\":\"Copyright (C) 2016 Timble CVBA\",\"authorEmail\":\"info@joomlatools.com\",\"authorUrl\":\"www.joomlatools.com\",\"version\":\"2.0.0\",\"description\":\"PLG_KOOWA_CONNECT_DESCRIPTION\",\"group\":\"\",\"filename\":\"connect\"}','{\"api_key\":\"b992f14b-dda8-11e2-9ede-4040daf17631\",\"secret_key\":\"9738af5426ebec0c4d2f76e3641a8015c250163c\"}','','',951,'2018-01-05 14:46:10',0,0);
...
VALUES
	(1,'fileman-files','FILEman','joomlatools-files/fileman-files','{\"thumbnails_container\":\"fileman-thumbnails\",\"allowed_extensions\":[\"csv\",\"doc\",\"docx\",\"html\",\"key\",\"keynote\",\"odp\",\"ods\",\"odt\",\"pages\",\"pdf\",\"pps\",\"ppt\",\"pptx\",\"rtf\",\"tex\",\"txt\",\"xls\",\"xlsx\",\"xml\",\"bmp\",\"exif\",\"gif\",\"ico\",\"jpeg\",\"jpg\",\"png\",\"psd\",\"tif\",\"tiff\",\"3gp\",\"asf\",\"avi\",\"flv\",\"m4v\",\"mkv\",\"mov\",\"mp4\",\"mpeg\",\"mpg\",\"ogg\",\"rm\",\"swf\",\"vob\",\"wmv\",\"aac\",\"aif\",\"aiff\",\"alac\",\"amr\",\"au\",\"cdda\",\"flac\",\"m3u\",\"m4a\",\"m4p\",\"mid\",\"mp3\",\"mpa\",\"pac\",\"ra\",\"wav\",\"wma\"],\"maximum_size\":0,\"thumbnails\":true}'),
	(2,'fileman-thumbnails','FILEman Thumbnails','joomlatools-files/fileman-thumbnails','{\"versions\":{\"small\":{\"dimension\":{\"width\":320,\"height\":320},\"crop\":false},\"medium\":{\"dimension\":{\"width\":768,\"height\":768},\"crop\":false},\"large\":{\"dimension\":{\"width\":1024,\"height\":1024},\"crop\":false}}}'),
	(3,'fileman-attachments','FILEman Attachments','joomlatools-files/fileman-attachments','{\"thumbnails_container\":\"fileman-attachments-thumbnails\",\"allowed_extensions\":[\"csv\",\"doc\",\"docx\",\"html\",\"key\",\"keynote\",\"odp\",\"ods\",\"odt\",\"pages\",\"pdf\",\"pps\",\"ppt\",\"pptx\",\"rtf\",\"tex\",\"txt\",\"xls\",\"xlsx\",\"xml\",\"bmp\",\"exif\",\"gif\",\"ico\",\"jpeg\",\"jpg\",\"png\",\"psd\",\"tif\",\"tiff\",\"3gp\",\"asf\",\"avi\",\"flv\",\"m4v\",\"mkv\",\"mov\",\"mp4\",\"mpeg\",\"mpg\",\"ogg\",\"rm\",\"swf\",\"vob\",\"wmv\",\"aac\",\"aif\",\"aiff\",\"alac\",\"amr\",\"au\",\"cdda\",\"flac\",\"m3u\",\"m4a\",\"m4p\",\"mid\",\"mp3\",\"mpa\",\"pac\",\"ra\",\"wav\",\"wma\"],\"maximum_size\":0,\"thumbnails\":true,\"check_duplicates\":\"confirm\"}'),
	(4,'fileman-attachments-thumbnails','FILEman Attachments Thumbnails','joomlatools-files/fileman-attachments-thumbnails','{\"dimension\":{\"width\":320,\"height\":320},\"crop\":false}'),
	(5,'fileman-user-files','FILEman User Files','joomlatools-files/fileman-user-files','{\"thumbnails_container\":\"fileman-user-thumbnails\",\"allowed_extensions\":[\"csv\",\"doc\",\"docx\",\"html\",\"key\",\"keynote\",\"odp\",\"ods\",\"odt\",\"pages\",\"pdf\",\"pps\",\"ppt\",\"pptx\",\"rtf\",\"tex\",\"txt\",\"xls\",\"xlsx\",\"xml\",\"bmp\",\"exif\",\"gif\",\"ico\",\"jpeg\",\"jpg\",\"png\",\"psd\",\"tif\",\"tiff\",\"3gp\",\"asf\",\"avi\",\"flv\",\"m4v\",\"mkv\",\"mov\",\"mp4\",\"mpeg\",\"mpg\",\"ogg\",\"rm\",\"swf\",\"vob\",\"wmv\",\"aac\",\"aif\",\"aiff\",\"alac\",\"amr\",\"au\",\"cdda\",\"flac\",\"m3u\",\"m4a\",\"m4p\",\"mid\",\"mp3\",\"mpa\",\"pac\",\"ra\",\"wav\",\"wma\"],\"maximum_size\":0,\"thumbnails\":true}'),
	(6,'fileman-user-thumbnails','FILEman User Thumbnails','joomlatools-files/fileman-user-thumbnails','{\"versions\":{\"small\":{\"dimension\":{\"width\":320,\"height\":320},\"crop\":false},\"medium\":{\"dimension\":{\"width\":768,\"height\":768},\"crop\":false},\"large\":{\"dimension\":{\"width\":1024,\"height\":1024},\"crop\":false}}}'),
	(7,'textman-files','TEXTman Files','images','{\"allowed_extensions\":[\"csv\",\"doc\",\"docx\",\"html\",\"key\",\"keynote\",\"odp\",\"ods\",\"odt\",\"pages\",\"pdf\",\"pps\",\"ppt\",\"pptx\",\"rtf\",\"tex\",\"txt\",\"xls\",\"xlsx\",\"xml\"],\"allowed_mimetypes\":[\"application\\/msword\",\"application\\/pdf\",\"application\\/rtf\",\"application\\/vnd.ms-excel\",\"application\\/vnd.ms-powerpoint\",\"application\\/vnd.ms-powerpoint\",\"application\\/vnd.oasis.opendocument.presentation\",\"application\\/vnd.oasis.opendocument.spreadsheet\",\"application\\/vnd.oasis.opendocument.text\",\"application\\/vnd.openxmlformats-officedocument.presentationml.presentation\",\"application\\/vnd.openxmlformats-officedocument.spreadsheetml.sheet\",\"application\\/vnd.openxmlformats-officedocument.wordprocessingml.document\",\"application\\/x-tex\",\"application\\/xml\",\"text\\/csv\",\"text\\/html\",\"text\\/plain\"]}'),
	(8,'textman-images','TEXTman Images','images','{\"allowed_extensions\":[\"bmp\",\"gif\",\"jpeg\",\"jpg\",\"png\"],\"allowed_mimetypes\":[\"image\\/bmp\",\"image\\/gif\",\"image\\/jpeg\",\"image\\/jpeg\",\"image\\/png\"],\"maximum_image_size\":null}');
...
# Dump of table j_logman_activities
# ------------------------------------------------------------

DROP TABLE IF EXISTS `j_logman_activities`;

CREATE TABLE `j_logman_activities` (
  `logman_activity_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `j_logman_activities` WRITE;
/*!40000 ALTER TABLE `j_logman_activities` DISABLE KEYS */;

INSERT INTO `j_logman_activities` (`logman_activity_id`, `uuid`, `application`, `type`, `package`, `name`, `action`, `row`, `title`, `status`, `created_on`, `created_by`, `ip`, `metadata`)
VALUES
	(1,'7ef059dd1d6d42b1821ea4225f44a1be','admin','com','installer','plugin','install','10030','plg_content_filelink','installed','2018-01-05 14:43:00',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"site\",\"element\":\"filelink\",\"name\":\"plg_content_filelink\",\"folder\":\"content\"}'),
	(2,'fcf6a13ff95e4a3bbb1d422e69822bd0','admin','com','installer','plugin','install','10031','plg_editors-xtd_filelink','installed','2018-01-05 14:43:00',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"site\",\"element\":\"filelink\",\"name\":\"Button - FILElink\",\"folder\":\"editors-xtd\"}'),
	(3,'769dedd0e43f47d3ad4135b62d42dc61','admin','com','installer','plugin','install','10032','plg_editors-xtd_attachments','installed','2018-01-05 14:43:01',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"site\",\"element\":\"attachments\",\"name\":\"Button - Attachments\",\"folder\":\"editors-xtd\"}'),
	(4,'8bb907623beb495ab84f3280e35c5769','admin','com','installer','plugin','install','10033','plg_koowa_fileman','installed','2018-01-05 14:43:01',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"site\",\"element\":\"fileman\",\"name\":\"plg_koowa_fileman\",\"folder\":\"koowa\"}'),
	(5,'39ad1e1838e14d318452a520f1daad57','admin','com','installer','plugin','update','10027','plg_system_joomlatoolsupdater','upgraded','2018-01-05 14:43:01',951,'127.0.0.1','{\"version\":\"1.0.0\",\"client\":\"site\",\"element\":\"joomlatoolsupdater\",\"name\":\"plg_system_joomlatoolsupdater\",\"folder\":\"system\"}'),
	(6,'54ab383e018948a79072c0cea7d1a436','admin','com','installer','plugin','install','10034','plg_system_joomlatoolsscheduler','installed','2018-01-05 14:43:01',951,'127.0.0.1','{\"version\":\"1.0.0\",\"client\":\"site\",\"element\":\"joomlatoolsscheduler\",\"name\":\"plg_system_joomlatoolsscheduler\",\"folder\":\"system\"}'),
	(7,'2c4265357d4840e0b85039ab7ca9e7cf','admin','com','installer','module','install','10035','mod_fileman_folders','installed','2018-01-05 14:43:01',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"site\",\"element\":\"mod_fileman_folders\",\"name\":\"mod_fileman_folders\",\"folder\":\"\"}'),
	(8,'9a7d6eb21aa24bc09d41c8b5254938f2','admin','com','installer','module','install','10036','mod_fileman_files','installed','2018-01-05 14:43:01',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"site\",\"element\":\"mod_fileman_files\",\"name\":\"mod_fileman_files\",\"folder\":\"\"}'),
	(9,'271bb6ab5698456d9678045b6dae1967','admin','com','installer','component','install','10029','com_fileman','installed','2018-01-05 14:43:02',951,'127.0.0.1','{\"version\":\"3.1.2\",\"client\":\"admin\",\"element\":\"com_fileman\",\"name\":\"com_fileman\",\"folder\":\"\"}'),
	(10,'6de32cec4a454ef586e4fd06951e25ba','admin','com','installer','plugin','install','10039','plg_content_textman','installed','2018-01-05 14:45:07',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"textman\",\"name\":\"plg_content_textman\",\"folder\":\"content\"}'),
	(11,'e67774c2af6641fb80cbaa3c9c6dbfe2','admin','com','installer','plugin','install','10040','plg_system_textman','installed','2018-01-05 14:45:08',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"textman\",\"name\":\"plg_system_textman\",\"folder\":\"system\"}'),
	(12,'f0d5450fde24406395be05919eedd0c6','admin','com','installer','plugin','install','10041','plg_logman_textman','installed','2018-01-05 14:45:08',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"textman\",\"name\":\"plg_logman_textman\",\"folder\":\"logman\"}'),
	(13,'de5545a2f260491e95106d35d649b051','admin','com','installer','plugin','install','10042','plg_textman_notify','installed','2018-01-05 14:45:08',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"notify\",\"name\":\"plg_textman_notify\",\"folder\":\"textman\"}'),
	(14,'56618e0cdd264a9d8d2f74a8d8d91c6c','admin','com','installer','plugin','update','10027','plg_system_joomlatoolsupdater','upgraded','2018-01-05 14:45:08',951,'127.0.0.1','{\"version\":\"1.0.0\",\"client\":\"site\",\"element\":\"joomlatoolsupdater\",\"name\":\"plg_system_joomlatoolsupdater\",\"folder\":\"system\"}'),
	(15,'6258d6b472054801a42b280bdcf2970e','admin','com','installer','plugin','update','10039','plg_content_textman','upgraded','2018-01-05 14:45:43',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"textman\",\"name\":\"plg_content_textman\",\"folder\":\"content\"}'),
	(16,'e1d81d843d2646fe83cf4cfcc574583f','admin','com','installer','plugin','update','10040','plg_system_textman','upgraded','2018-01-05 14:45:43',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"textman\",\"name\":\"plg_system_textman\",\"folder\":\"system\"}'),
	(17,'09bb8551330746e28b442c393c4f29db','admin','com','installer','plugin','update','10041','plg_logman_textman','upgraded','2018-01-05 14:45:43',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"textman\",\"name\":\"plg_logman_textman\",\"folder\":\"logman\"}'),
	(18,'bd734c4d84ff4659be51a86ed557a119','admin','com','installer','plugin','update','10042','plg_textman_notify','upgraded','2018-01-05 14:45:44',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"notify\",\"name\":\"plg_textman_notify\",\"folder\":\"textman\"}'),
	(19,'9eea6412bbd04c5abdd332c6f71fb2b5','admin','com','installer','plugin','update','10027','plg_system_joomlatoolsupdater','upgraded','2018-01-05 14:45:44',951,'127.0.0.1','{\"version\":\"1.0.0\",\"client\":\"site\",\"element\":\"joomlatoolsupdater\",\"name\":\"plg_system_joomlatoolsupdater\",\"folder\":\"system\"}'),
	(20,'897b55ef03b34b999ab6039eb143c1e1','admin','com','installer','component','update','10038','com_textman','upgraded','2018-01-05 14:45:46',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"admin\",\"element\":\"com_textman\",\"name\":\"com_textman\",\"folder\":\"\"}'),
	(21,'f06c59ef3cf941f8919c00ff432c2a2d','admin','com','installer','plugin','install','10044','plg_koowa_connect','installed','2018-01-05 14:46:00',951,'127.0.0.1','{\"version\":\"2.0.0\",\"client\":\"site\",\"element\":\"connect\",\"name\":\"plg_koowa_connect\",\"folder\":\"koowa\"}');

/*!40000 ALTER TABLE `j_logman_activities` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(1,'','Menu_Item_Root',X'726F6F74','','','','',1,0,0,0,0,'0000-00-00 00:00:00',0,0,'',0,'',0,265,0,'*',0),
	...
	(471,'main','COM_LOGMAN',X'636F6D5F6C6F676D616E','','com_logman','index.php?option=com_logman','component',1,1,1,10003,0,'0000-00-00 00:00:00',0,1,'class:component',0,'{}',261,262,0,'',1),
	(472,'main','COM_FILEMAN',X'636F6D5F66696C656D616E','','com_fileman','index.php?option=com_fileman','component',1,1,1,10029,0,'0000-00-00 00:00:00',0,1,'class:component',0,'{}',263,264,0,'',1);
...
VALUES
	...
	(91,181,'LOGman - Activity Stream','','',-1,'cpanel',0,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00',1,'mod_logman',1,1,'{\"limit\":\"10\",\"direction\":\"desc\"}',1,'*'),
	(92,182,'LOGman - Activity Stream','','',0,'',0,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00',0,'mod_logman',1,1,'',0,'*'),
	(93,185,'FILEman - Folders','','',0,'',0,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00',0,'mod_fileman_folders',1,1,'',0,'*'),
	(94,186,'FILEman - Files','','',0,'',0,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00',0,'mod_fileman_files',1,1,'',0,'*');
...
VALUES
	('7ff4469a-5add-46ce-87c7-a5a9eba11f76','com://admin/fileman.job.attachments','fileman','0 0 * * *',0,1,1,'[]','2018-01-05 14:44:38','0000-00-00 00:00:00'),
	('98b71820-613c-4051-a176-2b2f3d063121','com://admin/fileman.job.scans','fileman','*/5 * * * *',0,0,2,'[]','2018-01-05 14:44:38','2018-01-05 14:44:38');
...
VALUES
	('metadata','2018-01-05 14:44:38','2018-01-05 14:44:38');
...
VALUES
	('6n5279oo1ggrtraf0bbikvmpam',1,0,'1515163571','joomla|s:1644:\"\";__koowa|a:3:{s:10:\"__metadata\";a:2:{s:5:\"timer\";a:3:{s:5:\"start\";i:1515163339;s:4:\"last\";i:1515163569;s:3:\"now\";i:1515163571;}s:5:\"token\";s:40:\"97e73d6243040939c5f6ca71f6c4e4944484665c\";}s:11:\"__attribute\";a:1:{s:4:\"user\";a:12:{s:2:\"id\";s:3:\"951\";s:5:\"email\";s:17:\"admin@example.com\";s:4:\"name\";s:10:\"Super User\";s:8:\"username\";s:5:\"admin\";s:8:\"password\";s:60:\"$2y$10$Y93QkQQQeCWV15rjaLb1oefi3tBuMmo7vmjlIu.CTd9dldNvFXxu2\";s:4:\"salt\";s:0:\"\";s:9:\"authentic\";b:1;s:7:\"enabled\";b:1;s:7:\"expired\";b:1;s:10:\"attributes\";a:7:{s:11:\"admin_style\";s:0:\"\";s:14:\"admin_language\";s:0:\"\";s:8:\"language\";s:0:\"\";s:6:\"editor\";s:0:\"\";s:8:\"helpsite\";s:0:\"\";s:8:\"timezone\";s:0:\"\";s:18:\"com://admin/logman\";a:1:{s:4:\"view\";a:1:{s:10:\"activities\";a:1:{s:4:\"html\";a:1:{s:18:\"com://admin/logman\";a:1:{s:5:\"model\";a:1:{s:10:\"activities\";a:1:{s:6:\"browse\";a:18:{s:6:\"search\";N;s:5:\"limit\";i:20;s:6:\"offset\";i:0;s:4:\"sort\";s:10:\"created_on\";s:11:\"application\";N;s:4:\"type\";N;s:7:\"package\";N;s:4:\"name\";N;s:6:\"action\";N;s:3:\"row\";N;s:4:\"user\";N;s:10:\"start_date\";N;s:8:\"end_date\";N;s:9:\"day_range\";N;s:2:\"ip\";N;s:9:\"direction\";s:4:\"desc\";s:9:\"usergroup\";N;s:15:\"resource_action\";N;}}}}}}}}}s:5:\"roles\";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:6:\"groups\";a:2:{i:0;i:1;i:1;i:8;}}}s:9:\"__message\";a:0:{}}',951,'admin'),
	('cf46hhu26bq6ete3fic49osbp6',0,1,'1515163478','__koowa|a:2:{s:10:\"__metadata\";a:1:{s:5:\"timer\";a:3:{s:5:\"start\";i:1515163477;s:4:\"last\";i:1515163477;s:3:\"now\";i:1515163477;}}s:11:\"__attribute\";a:1:{s:4:\"user\";a:12:{s:2:\"id\";i:0;s:5:\"email\";N;s:4:\"name\";N;s:8:\"username\";N;s:8:\"password\";N;s:4:\"salt\";s:0:\"\";s:9:\"authentic\";b:0;s:7:\"enabled\";b:1;s:7:\"expired\";b:1;s:10:\"attributes\";a:0:{}s:5:\"roles\";a:0:{}s:6:\"groups\";a:0:{}}}}joomla|s:752:\"\";',0,'');
...
VALUES
	(1,'Joomla! Core','collection','https://update.joomla.org/core/list.xml',1,1515163310,''),
	...
	(4,'LOGman','extension','https://api.joomlatools.com/extension/logman.xml',1,0,''),
	(5,'FILEman','extension','https://api.joomlatools.com/extension/fileman.xml',1,0,''),
	(6,'TEXTman','extension','https://api.joomlatools.com/extension/textman.xml',1,0,''),
	(7,'Connect','extension','https://api.joomlatools.com/extension/connect.xml',1,0,'');
...
VALUES
	(951,'Super User','admin','admin@example.com','$2y$10$Y93QkQQQeCWV15rjaLb1oefi3tBuMmo7vmjlIu.CTd9dldNvFXxu2',0,1,'2013-07-24 09:07:43','2018-01-05 14:41:54','0','{\"admin_style\":\"\",\"admin_language\":\"\",\"language\":\"\",\"editor\":\"\",\"helpsite\":\"\",\"timezone\":\"\"}','0000-00-00 00:00:00',0,'','',0),
